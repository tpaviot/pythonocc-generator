...
OCE_MODULES = [
           ...
           ### TKV3d
           ('V3d', 
            ['TShort', 'TColQuantity', 'Bnd', 'Geom', 'BVH'],
            [],
            {'V3d_Viewer': 'Print', 
             'V3d_View': 'Print'}
            ),
           ('Graphic3d', 
            ['TShort', 'TColQuantity', 'BVH'],
