...
OCE_MODULES = [
           ...
           ('Graphic3d', 
            ['TShort', 'TColQuantity', 'BVH', 'TopTools', 'V3d', 'SelectMgr',
             'HLRAlgo', 'Poly'],
           ...
           ### TKSTEPBase
           ('StepData', [], ['StepData_FreeFormEntity', 'StepData_UndefinedEntity'],
           ...
           ('STEPControl', ['Message', 'TopLoc', 'Dico', 'StepBasic',
                            'Transfer', 'Geom2d', 'Geom', 'Interface'], []),
