...
TOOLKIT_Modeling = {
            'TKG2d': ['Geom2d', 'LProp', 'TColGeom2d', 'Adaptor2d',
                      'Geom2dLProp', 'Geom2dAdaptor', 'GProp', 'Geom2dEvaluator'],
            ...
            'TKGeomAlgo': ['Hatch', 'GeomInt', 'IntStart', 'IntWalk',
                           ...
                           'GccInt', 'GccIter', 'HatchGen', 'Geom2dHatch', 'Law',
            ...
            'TKPrim': ['BRepPrim', 'BRepSweep', 'Sweep',
                       'BRepPrimAPI'],
            'TKBO': ['IntTools', 'BRepAlgoAPI', 'BOPCol', 'BOPDS',
                     'BOPAlgo', 'BOPTools'],
            'TKHLR': ['HLRTopoBRep', 'HLRBRep', 'HLRAlgo', 'HLRAppli',
                      'Intrv', 'TopBas', 'TopCnx', 'Contap'],
            'TKMesh': ['BRepMesh', 'IntPoly', 'IMeshTools', 'IMeshData'],
