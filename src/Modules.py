...
TOOLKIT_DataExchange = {
    "TKBinXCAF": ["BinMXCAFDoc", "BinXCAFDrivers"],
    "TKIGES": ["IGESControl", "IGESData", "IGESToBRep"],
    "TKRWMesh": ["RWGltf", "RWObj", "RWMesh", "RWPly"],
    "TKSTEP": [
        "GeomToStep",
        "RWStepAP203",
        "RWStepAP214",
...
OCE_MODULES = [
    ...
    (
        "Message",
        [],
        ["Message_ProgressScope", "Message_LazyProgressScope"],
        {
            "Message": [
                "Send",
                "SendAlarm",
    ...
    (
        ...
        ["Message"],
        [],
        {"ProjLib_ProjectOnSurface": ["Load"], "ProjLib_ProjectedCurve": ["Load"]},
    ),
    ("GeomProjLib", [], []),
    (
        "GCPnts",
    ...
    (
        "GeomConvert",
        ["Geom2d", "Adaptor3d", "Adaptor2d", "Message"],
        [],
    ...
    (
        "AdvApp2Var",
        ["PLib", "Message"],
        ["AdvApp2Var_EvaluatorFunc2Var", "AdvApp2Var_Iso"],
    ...
    (
        "AppDef",
        ["Adaptor2d", "Adaptor3d", "Geom", "Geom2d", "PLib", "Message"],
        [],
        {
    ...
    (
        "BinTools",
        ["Message", "CDF"],
        ["BinTools_IStream", "BinTools_OStream"],
    ...
    (
        "GeomInt",
        ["Bnd", "IntAna", "Adaptor2d", "GeomAdaptor", "Adaptor3d", "Message"],
        ["GeomInt_WLApprox"],
        {
    ...
    (
        "Geom2dInt",
        ["Adaptor3d", "Geom", "Geom2d", "GeomAdaptor", "Message"],
        [],
        {
    ...
    (
        "ApproxInt",
        ["Adaptor3d", "Geom", "Adaptor2d", "Geom2d", "Message", "AppParCurves", "Bnd"],
        [],
    ),
    ("GccAna", [], []),
    ("GccEnt", [], []),
    ...
    (
        "GeomAPI",
        ["Adaptor3d", "Adaptor2d", "GeomAdaptor", "AppParCurves", "Message"],
        [],
        {"GeomAPI_Interpolate": ["ClearTangents"]},
    ),
    (
        "GeomFill",
        ["Adaptor2d", "FEmTool", "AppParCurves", "PLib", "Message"],
        ["GeomFill_SweepSectionGenerator"],
        {
            "GeomFill_FunctionGuide": ["Deriv2T"],
            "GeomFill_NSections": [
                "GeomFill_NSections::637af4a0f33ec19afb7aacd41d59fa97"
            ],
        },
    ),
    (
    ...
    (
        "IntPolyh",
        ["Geom", "Geom2d", "Adaptor2d", "Message"],
        ["IntPolyh_Array", "IntPolyh_MaillageAffinage"],
    ...
    (
        "IntCurvesFace",
        ["TopLoc", "IntSurf", "Geom", "Geom2d", "Adaptor2d", "Message"],
        [],
    ),
    ("MAT", [], []),
    ...
    (
        ...
        ["BRepClass3d_BndBoxTreeSelectorLine", "BRepClass3d_BndBoxTreeSelectorPoint"],
    ),
    (
        "BRepLib",
        ...
        [],
        {
            ...
            "BRepLib_ValidateEdge": ["SetExitIfToleranceExceeded"],
        },
    ),
    (
        "BRepGProp",
        ...
        ["BRepGProp_MeshProps"],
        {"BRepGProp_VinertGK": ["GetAbsolutError"], "BRepGProp_Gauss": ["Compute"]},
    ),
    (
        "BRepIntCurveSurface",
        [
    ...
    (
        "BRepTopAdaptor",
        ["Geom", "Geom2d", "GeomAdaptor", "TopLoc", "Geom2dAdaptor", "Message"],
        [],
    ),
    (
        "BRepBuilderAPI",
    ...
    (
        ...
        ["IntTools_CArray1OfInteger", "IntTools_CArray1OfReal"],
    ...
    (
        "ShapeExtend",
        ["TColgp", "TopLoc", "Poly", "IntRes2d", "BRepBuilderAPI", "GeomAdaptor"],
        [],
    ),
    (
        "ShapeConstruct",
    ...
    ("BlendFunc", ["Geom2d", "Geom", "Message"], [], {"BlendFunc": ["Mults", "Knots"]}),
    (
        "BRepFilletAPI",
        [
            "Adaptor3d",
    ...
    (
        ...
        [
            ...
            "Graphic3d_UniformValueType",
            "Graphic3d_UniformValueTypeID",
            "Graphic3d_Buffer",
        ...
        ],
        {
            ...
            "Graphic3d_Layer": [
                ...
                "Graphic3d_Layer",  # to avoid circular dep #60
    ...
    (
        "SelectBasics",
        ["Bnd", "Geom", "Select3D", "Graphic3d", "Aspect", "Quantity"],
        [],
    ),
    (
        "PrsMgr",
    ...
    (
        "RWStepBasic",
        ["MoniTool", "TCollection", "StepBasic", "Message", "TopoDS", "Resource"],
        [],
    ),
    (
        "StepRepr",
    ...
    (
        ...
        {"VrmlData_IndexedFaceSet": ["GetNormal"]},
    ),  # Fixes undefined ref
    #
    # TKRWMesh
    #
    ...
    (
        "BinMNaming",
        ["Resource", "Geom", "TopoDS", "Geom2d", "Message", "TopLoc", "TDF"],
        [],
    ),
    ### TKBinLd
    ("BinLDrivers", ["Resource", "TDF", "CDF"], []),
    ("BinMDF", ["Resource", "TDF"], []),
    ("BinMDataStd", ["Resource", "TDF"], [], {"BinMDataStd": ["SetAttributeID"]}),
    ...
    (
        "BinMXCAFDoc",
        ["Resource", "Geom", "TopoDS", "Geom2d", "Message", "XCAFView", "TDF"],
        [],
    ),
    ### TKXml
    ...
    (
        "XCAFDoc",
        ["Resource", "Message", "CDF", "CDM", "PCDM", "TDF", "Aspect", "Bnd", "Media"],
    ...
    (
        "XCAFDimTolObjects",
        ["Message", "CDF", "CDM", "PCDM", "LDOM", "TDF", "Resource", "TopLoc"],
        [],
    ),
    ("XCAFView", [], []),
