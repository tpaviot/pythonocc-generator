...
OCE_MODULES = [
           ...
           ('Standard', [], ['Standard_AncestorIterator',
                             ...
                             'Standard_Type', 'Standard_Failure'], #occt720
           ...
           ('TopAbs', [], []),
           ('GeomEvaluator', ['Geom2d', 'Adaptor2d'], []),
           ### TKGeomBase
           ('ProjLib', [], [],
           ...
           ### TKGeomAlgo
           ('Hatch', [], []),
           ('GeomInt', ['Bnd', 'IntAna', 'Adaptor2d'], ['GeomInt_WLApprox'],
           ...
           ('BRepGProp', ['Adaptor3d', 'TopLoc', 'Geom2dAdaptor', 'Geom', 'Geom2d',
                          'Adaptor2d', 'GeomAdaptor', 'Message', 'Bnd'], [],
           ...
           ('TopBas', ['Message'], []),
           ('TopCnx', [], []),
           ('Contap', ['TColgp', 'Geom', 'NCollection'], []),
           ### TKMesh
           ...
           ('ShapeAnalysis', ['TColGeom', 'Message', 'Adaptor2d'],
           ...
           ('StdPrs', ['Adaptor3d', 'GeomAdaptor', 'Message', 'Geom2d', 'Geom2dAdaptor',
                       'Quantity', 'TopTools', 'TShort', 'Aspect'], ['StdPrs_DeflectionCurve']),
           ('SelectMgr', ['TopTools', 'Message', 'TShort', 'SelectBasics',
                    'Visual3d', 'HLRAlgo', 'TColQuantity', 'Geom', 'Aspect',
                    'Poly', 'TopoDS', 'V3d', 'Select3D', 'Graphic3d', 'Quantity', 'BVH'],
           ...
           ('AIS', ['TopTools', 'Message', 'TShort', 'SelectBasics',
                    'Visual3d', 'HLRAlgo', 'TColQuantity', 'SelectMgr',
                    'HLRAlgo'], [],
           ...
           ### TKSTEP
           ('StepAP214', ['Message', 'StepBasic', 'StepData'], []),
           ...
           ('GeomToStep', ['Message', 'StepBasic', 'StepBasic', 'StepGeom',  'StepRepr',
           ...
           ('BinMNaming', ['Resource', 'Geom', 'TopoDS', 'Geom2d', 'Message', 'TopLoc'], []),
           ### TKBinLd
           ...
           ('BinObjMgt', [], []),
           ### TKBinTObj
           ('BinTObjDrivers', ['Resource', 'PCDM', 'LDOM', 'CDF'], []),
           ### TKBinXCAF'
